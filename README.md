<h1 align="center">Hi 👋, I'm Jitesh Kumar</h1>  </div>
...
<p align="left"> <a href="https://github.com/ryo-ma/github-profile-trophy"><img src="https://github-profile-trophy.vercel.app/?username=jiteshkumarkumar" ></a> </p>


## 🚀 About Me

I am ✨ **Jitesh Kumar**✨, I possess over 5 years of experience in the IT industry, with a total of 8 years of professional experience across various domains. I deepened my knowledge and skills in data mining, predictive analytics, and big data. With hands-on experience from companies like Vaco Binary Sementric. and Concentrix Daksh Private limited, I have honed my abilities in optimizing data pipelines, conducting data correlations analysis, and creating impactful data visualizations. My passion lies in using data-driven insights to solve complex problems and drive business strategies. I'm proficient in Python, SQL, Alteryx,SAS, Advance Excel and various data visualization tools like Tableau & Power BI, and I'm always eager to learn and explore the latest trends in data science and machine learning. Let's connect and explore the fascinating world of data together!



## 🎯 Current Focus & Learning Trajectory
I'm actively exploring and building expertise in the following high-impact areas:

- Generative AI & RAG Applications: Developing and deploying Retrieval Augmented Generation (RAG) tools to enhance information retrieval and content creation. (This highlights - your specific learning in the field.)
- Machine Learning Engineering: Designing, training, and deploying scalable ML models to solve complex real-world challenges.
- Big Data Ecosystems: Mastering large-scale data processing and analysis using technologies like Apache Spark and Hadoop.
- Data Storytelling & Visualization: Translating complex data into clear, impactful visual narratives using tools such as Tableau and Power BI.
- Healthcare Analytics: Applying data science methodologies to drive improvements in patient care and operational efficiency within the healthcare sector.
...
- **Data Analysis/Machine Learning/Deep Learning:** NumPy, Pandas
- **Statistic Analysis:** SAS (Statistical Analysis System or Software)
- **Data Analytics and Process Automation platforms:** Alteryx
